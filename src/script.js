...
import spectraVertexShader from './shaders/spectraShader/vertex.glsl'
import spectraFragmentShader from './shaders/spectraShader/fragment.glsl'
...
spectraGeometry.setAttribute('displacement', new THREE.Uint8BufferAttribute(heights,1));
...
const tick = () =>
{
	...
	spectraMesh.geometry.setAttribute('displacement', new THREE.Uint8BufferAttribute(heights, 1));
}
